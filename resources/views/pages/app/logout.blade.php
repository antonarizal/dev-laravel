                    ...
                    <div class="flex flex-col gap-6">
                        <div
                            ...
                            <div class="mt-10 mx-10 ">
                                <h3 class="font-bold text-4xl">Logout,</h3>
                                <h4>Anda telah keluar. Silakan login untuk memulai ujian.</h4>
                            </div>
                            <div class="p-10">
                                <flux:button href="login" class="w-full" variant="primary" icon-trailing="arrow-right">
                                    Login disini
                                </flux:button>
                            </div>
                        </div>
